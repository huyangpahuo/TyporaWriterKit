...
ShowColorGui()
{
    ...
    colors := [
        ["DarkOrange","濃いオレンジ"], ["Red","赤"], ["LightSkyBlue","空色"],
        ["Turquoise","ターコイズ"], ["MediumVioletRed","紫紅"], ["Teal","青緑"],
        ["Gold","金色"], ["DimGray","暗いグレー"], ["DeepPink","濃いピンク"],
        ["DodgerBlue","ドジャーブルー"], ["LimeGreen","ライムグリーンライムグリーン"], ["OrangeRed","オレンジレッド"],
        ["SlateBlue","スレートブルー"], ["Chocolate","チョコレート"], ["Crimson","クリムゾン"],
    ...
    btn := ColorGui.AddButton("xm y+10 w260", "カスタムカラー")
...
ShowCustomColorGui()
{
    ...
    CustomGui.AddText("xm y+6 Center", "この色を選択するにはクリックしてください")
